...
version `0.0.17`; cette valeur ne représente plus l'étendue fonctionnelle
réelle et devra être harmonisée avant une publication.
...
Ce bloc n'est pas numéroté : les manifestes portent encore `0.0.17` et la numérotation des jalons a divergé de la version du paquet. Le choix d'un numéro revient à l'auteur du projet, qui prévoit son premier commit Git en version 1.0.
